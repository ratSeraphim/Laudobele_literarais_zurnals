...
export const BgPaper = styled(Paper)`
	background-image: url(https://i.ibb.co/424JH9S/img-noise-361x370-3.png);
	...
	padding: 0.3rem;
`;
//  https://i.ibb.co/sQ8ykvF/img-noise-361x370-2.png
...
export const Letter = styled("div")`
	...
	padding: 3rem;
	margin: 1rem;
	box-shadow: 5px 3px 5px rgba(0, 0, 4, 0.5), 0 0 70px #8f5922 inset;
	background: #fffef0;
